...
def main():
    ...
    #model_name = "simpleAE"
    model_name = "convAE"
    process_and_save_icc_images = False  # image preproc: resize icc_images and save?
    ...
    # Process and save
    if process_and_save_icc_images:
    ...
    if train_autoencoder:
        ...
        # Split icc_images to training and validation set
    ...
    # =================================
    # Perform kNN on query icc_images
    # =================================
