...
def main():
    ...
    # ================================================
    #
    # From utility matrix, build uu-identicality matrix
    #
    # ================================================
    ...
    print("Building uu-identicality table = {0}...".format(sim_uu.shape))

    # ================================================
    #
    # Compute item scores using uu-identicality table
    #
    # ================================================
    ...
    print("Building ui-score table = {0} with top k_agg = {1} identical users...".format(score_ui.shape, k_users_aggregate))
    if 0:
        print(score_norm_ui)
        print(score_ui)
