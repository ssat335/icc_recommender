...
# - (n, ypixels, xpixels) if gray_scale == True
# - (n, ypixels, xpixels, n_channels) if gray_scale == False
def load_icc_images_from_dir(dir, ratio_training_test, frac_training_use, n_clone, seed, gray_scale):
    index_train = []
    index_test = []
    x_train = []
    x_test = []
...
# loads icc_images from a directory (parallel) in:
# - (n, ypixels, xpixels) if gray_scale == True
# - (n, ypixels, xpixels, n_channels) if gray_scale == False
def load_icc_images_from_dir_parallel(dir, ratio_training_test, frac_training_use, n_clone, seed, gray_scale, n_cores):
    index_train = []
    index_test = []
    x_train = []
    x_test = []
